...
logging.basicConfig(level=logging.INFO, format="%(asctime)s - %(levelname)s - %(message)s", handlers=[logging.FileHandler("error.log"), logging.StreamHandler()])
...
class ErrorController(QObject):
    ...
    def show_error(self, title: str, message: str, error_details: str = ""):
        ...
        QMessageBox.critical(self.parent_window, title, message, QMessageBox.StandardButton.Ok)
    ...
    def show_warning(self, title: str, message: str):
        ...
        QMessageBox.warning(self.parent_window, title, message, QMessageBox.StandardButton.Ok)
    ...
    def handle_exception(self, exception: Exception):
        ...
        self.show_error(f"Erreur: {error_type}", error_msg, traceback_str)
